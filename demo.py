...
class Ui_MainWindow(object):
    ...
    def file(self):
        ...
        print(img[0])
        #temp_imgSrc = QImage(img[0], img[0].shape[1], img[0].shape[0], QImage.Format_Format_Grayscale8)
        #pixmap_imgSrc = QPixmap.fromImage(temp_imgSrc).scaled(51, 51)
        #self.item = QGraphicsPixmapItem(pixmap_imgSrc)
        #self.scene = QGraphicsScene()  # 创建场景
        #self.scene.addItem(self.item)
        #self.old_img.setScene(self.scene)
        # lb = QVBoxLayout()
        # a = QWidget()
        # a.setLayout(lb)
        # for i in range(img.shape[0]):
        #     temp_label = QtWidgets.QLabel(self.centralwidget)
        #     temp_imgSrc = QImage(img[i], img[i].shape[1], img[i].shape[0], img[i].shape[1] * 3,
        #                          QImage.Format_RGB888)
        #     pixmap_imgSrc = QPixmap.fromImage(temp_imgSrc).scaled(51, 51)
        #     temp_label.setPixmap(pixmap_imgSrc)
        #     lb.addWidget(temp_label)
        # self.img_selcet.setWidget(a)
